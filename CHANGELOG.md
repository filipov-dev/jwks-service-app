...
- put the remaining Russian comments and the JWKS response description into English (JWKSAPP-11)

## [2.0.17] - 2026-08-29

### Internal

- require a green ci to merge into master (JWKSAPP-44)
...
[Unreleased]: https://github.com/filipov-dev/jwks-service-app/compare/v2.0.18...HEAD
[2.0.18]: https://github.com/filipov-dev/jwks-service-app/compare/v2.0.17...v2.0.18
[2.0.17]: https://github.com/filipov-dev/jwks-service-app/compare/v2.0.16...v2.0.17
[2.0.15]: https://github.com/filipov-dev/jwks-service-app/compare/v2.0.14...v2.0.15
